...
import space.zghoba.data.mappers.toCard
 ...
 */
private fun space.zghoba.model.SortOrder.toSqlSortOrder(): SortOrder = when (this) {
    space.zghoba.model.SortOrder.ASC -> SortOrder.ASC
    space.zghoba.model.SortOrder.DESC -> SortOrder.DESC
}